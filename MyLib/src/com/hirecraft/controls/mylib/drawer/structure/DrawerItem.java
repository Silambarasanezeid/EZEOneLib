package com.hirecraft.controls.mylib.drawer.structure;
 ...
 * {@link com.heinrichreimersoftware.materialdrawer.DrawerAdapter} and
 * {@link com.heinrichreimersoftware.materialdrawer.DrawerView} to display a
 * drawer item. Can hold an image, a primary text, a secondary text and a
 * listener.
 */
public class DrawerItem {
	 ...
	 * 
	 * @param isDivider
	 *            True if the drawer item should be a divider, false otherwise.
	 */
	...
	public DrawerItem setImageMode(int imageMode) {
		if (imageMode != ICON && imageMode != AVATAR) {
			throw new IllegalArgumentException(
					"Image mode must be either ICON or AVATAR.");
		}
	 ...
	 * 
	 * @return True if the drawer item has an image mode set to it, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return True if the drawer item has a primary text set to it, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return True if the drawer item has a secondary text set to it, false
	 *         otherwise.
	 */
	...
	public DrawerItem setTextMode(int textMode) {
		if (textMode != SINGLE_LINE && textMode != TWO_LINE
				&& textMode != THREE_LINE) {
			throw new IllegalArgumentException(
					"Image mode must be either SINGLE_LINE, TWO_LINE or THREE_LINE.");
		}
		mTextMode = textMode;
		notifyDataChanged();
		return this;
	 ...
	 * 
	 * @return True if the drawer item has a text mode set to it, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return True if the drawer item has a click listener set to it, false
	 *         otherwise.
	 */
