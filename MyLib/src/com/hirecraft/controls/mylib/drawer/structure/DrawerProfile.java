...
import com.hirecraft.controls.mylib.drawer.DrawerView;
 ...
 * profile in the drawer. Can hold an image, a primary text, a secondary text
 * and a listener.
 */
public class DrawerProfile {
	 ...
	 * 
	 * @return True if the drawer profile has an avatar image set to it, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return True if the drawer profile has a background set to it, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return True if the drawer profile has a description set to it, false
	 *         otherwise.
	 */
	 ...
	 *            Listener to set
	 */
	public DrawerProfile setOnProfileClickListener(
	 ...
	 * 
	 * @return True if the drawer profile has a click listener set to it, false
	 *         otherwise.
	 */
