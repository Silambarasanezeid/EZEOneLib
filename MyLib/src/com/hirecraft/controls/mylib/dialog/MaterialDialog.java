package com.hirecraft.controls.mylib.dialog;
...
/**
 * Created by silambarasan poonguti on 18/12/14.
 */
public class MaterialDialog {
	...
	public MaterialDialog setPositiveButton(int resId,
		...
		mPositiveButton.setTextColor(Color.rgb(0, 121, 107));
	...
	public MaterialDialog setNegativeButton(int resId,
		...
		mNegativeButton.setTextColor(Color.rgb(76,181,171));
	...
	private class Builder {
		...
		private Builder() {
			...
			mTitleView.setTextColor(Color.rgb(0, 121, 107));
		...
		public void setPositiveButton(String text,
			...
			button.setTextColor(Color.rgb(76,181,171));
			button.setText(text);
