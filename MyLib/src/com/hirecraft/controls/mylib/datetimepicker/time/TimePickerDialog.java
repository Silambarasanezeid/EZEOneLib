package com.hirecraft.controls.mylib.datetimepicker.time;
/*
...
import com.hirecraft.controls.mylib.utils.DateTimeUtils;
...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
        ...
        if (index == HOUR_INDEX) {
            ...
            if (announce) {
                DateTimeUtils.tryAccessibilityAnnounce(mTimePicker, mSelectHours);
            }
            ...
            if (announce) {
                DateTimeUtils.tryAccessibilityAnnounce(mTimePicker, mSelectMinutes);
            }
        ...
        com.nineoldandroids.animation.ObjectAnimator pulseAnimator = DateTimeUtils.getPulseAnimator(labelToAnimate, 0.85f, 1.1f);
    ...
    private boolean addKeyIfLegal(int keyCode) {
        ...
        DateTimeUtils.tryAccessibilityAnnounce(mTimePicker, String.format("%d", val));
