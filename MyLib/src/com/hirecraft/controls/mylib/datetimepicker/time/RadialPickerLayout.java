...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    public void initialize(Context context, int initialHoursOfDay, int initialMinutes,
        ...
        mHideAmPm = DateTimeUtils.isTouchExplorationEnabled(mAccessibilityManager) ? true : mIs24HourMode;
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mIsTouchingAmOrPm == AM || mIsTouchingAmOrPm == PM) {
                    ...
                    boolean forceLegal = DateTimeUtils.isTouchExplorationEnabled(mAccessibilityManager);
