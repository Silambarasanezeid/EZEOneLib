	...
	public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if(attrs != null) {
			...
			try {
                ...
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialTabsPrimaryColor, Color.parseColor("#19a093"));
                accentColor = a.getColor(R.styleable.MaterialTabHost_accentColor,Color.parseColor("#B2DFDB"));
