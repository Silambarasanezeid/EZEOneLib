package com.hirecraft.controls.mylib.swiperefresh;
 ...
 * @hide
 */
class CircleImageDrawable extends ImageView {
	...
	public CircleImageDrawable(Context context, int color, final float radius) {
		super(context);
	...
	private class OvalShadow extends OvalShape {
		...
		public void draw(Canvas canvas, Paint paint) {
			final int viewWidth = CircleImageDrawable.this.getWidth();
			final int viewHeight = CircleImageDrawable.this.getHeight();
